...
<script>
    ...
    $(document).ready(function () {
        $.post("achievementListTable.jsp",{page:1},function (data) {
    ...
    $(".pagingA").click(function () {
        ...
        $.post("achievementListTable.jsp",{page:this.innerHTML},function (data) {
            $("#achievementListTable").html(data);
        });
        checkPreviousAndNext();
    });
    ...
    $("#previous").click(function () {
        if(currentPage > 1){
            ...
            $.post("achievementListTable.jsp", {page:currentPage}, function (data) {
                $("#achievementListTable").html(data);
            });
            checkPreviousAndNext();
        }
