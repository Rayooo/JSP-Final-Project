...
<%
    ...
    try {
        ...
        String sql = "SELECT id,userName,sex,name,mobile,isManager,createTime FROM user WHERE isDeleted=0 AND isPassed=0 ORDER BY id DESC LIMIT "+ Integer.toString((currentPage-1)*10) +",10";//(页数-1)*每页条数,每页条数
